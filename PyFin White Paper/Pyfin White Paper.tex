...
\end{equation}
If the capital gains are realised by withdrawing the total amount, the exemption must be calculated. It is R40~000 in the 2019 tax year, and is assumed to grow with inflation\sidenote{The inclusion rate of 18\% is assumed to stay constant.}:
\begin{equation}
